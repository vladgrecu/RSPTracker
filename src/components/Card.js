...
const Card = ({name, Functie, Raion, id, Retea, Magazin, Oras, details}) => {
		...
		return (
				<div className='tc bg-light-gray dib br3 ma2 bw2 shadow-5 card w5  z-1 custom--o-95'>
						<div className={"ma0 shadow-5 br2 br--top fw6 " + reteaSwitch(Retea)}>{Retea}</div>
						<img className='br-100 ma2 bw1 ba b--black-20 custom--b--primary bg-center cover bg-white w4 h4' alt='foto' src={`https://robohash.org/${id}?size=150x150`}/>
						<div>
								<h3>{name}</h3>
								<p>{Functie}-{Raion}</p>
								<p>{Magazin}</p>
								...
								<div className="inline-flex items-center">
										<a onClick={details} className="f6 br2 link dim ph3 pv2 mb2 dib white bg-black ma1" href="#0">Details</a>
